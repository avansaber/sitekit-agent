...
func (a *Agent) sendHeartbeat(ctx context.Context) {
	...
	tools := health.CollectToolStatuses()
	dbHealth := health.CollectDatabaseHealth()

	if err := a.client.SendHeartbeat(ctx, stats, services, daemons, tools, dbHealth); err != nil {
